import { HOME_URL, LAYOUT_NAME, NOT_FOUND, FORBIDDEN_NAME, FORBIDDEN_URL, SERVER_ERROR_NAME, SERVER_ERROR_URL, GATEWAY_TIMEOUT_NAME, GATEWAY_TIMEOUT_URL, } from "@/common/config";
// 错误提示路由
const errorRouter = [
    {
        path: FORBIDDEN_URL,
