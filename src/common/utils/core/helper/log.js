...
const useLog = () => {
    ...
    const prettyPrint = (title, text, color) => {
        ...
        if (typeof title === "object") {
            console.log(title, `%c ${text} %c`, `background:${color};border:1px solid ${color}; padding: 1px; border-radius: 2px 0 0 2px; color: #fff;`, "background:transparent");
            return;
        }
        if (typeof text === "object") {
            console.log(`%c ${title} %c`, `background:${color};border:1px solid ${color}; padding: 1px; border-radius: 2px 0 0 2px; color: #fff;`, "background:transparent", text);
            return;
        }
