 ...
 */
export const processContentType = (config) => {
 ...
 */
export const getParamsProcessor = (paramsType) => {
    switch (paramsType) {
        case "brackets": {
