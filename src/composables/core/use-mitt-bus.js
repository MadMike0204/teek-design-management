import { OpenLockPanelKey, OpenSearchDialogKey, OpenThemePanelKey, RefreshIFrameKey, RefreshPageKey, } from "@/common/config";
import { mittBus } from "@/common/utils";
export const useMittBus = () => {
    /**
     * 刷新当前页面
     */
    const refreshPage = (value) => mittBus.emit(RefreshPageKey, value);
    /**
     * 打开主题面板
     */
