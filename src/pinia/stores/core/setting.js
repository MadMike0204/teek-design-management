...
import { HeaderMenuAlignEnum, HeaderStyleEnum, LayoutModeEnum, MenuThemeEnum, PageTransitionEnum, GlobalThemeEnum, TabNavElementModeEnum, MenuShowModeEnum, MenuStyleEnum, } from "@/common/enums";
import { serviceConfig } from "@/common/config";
import { cacheOperator, localStorageProxy } from "@/common/utils";
export const useSettingStore = defineStore("settingStore", () => {
    const { layout: layoutConfig, breadcrumb: breadcrumbConfig, header: headerConfig, tabNav: tabNavConfig, menu: menuConfig, theme: themeConfig, logo: logoConfig, transition: transitionConfig, widget: widgetConfig, shortcutKey: shortcutKeyConfig, } = serviceConfig;
    ...
    const primaryColor = computed({
        get: () => {
            const defaultMode = theme.globalThemeMode === GlobalThemeEnum.System
                ? isDark.value
